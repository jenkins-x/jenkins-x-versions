...
---------- | ------- | ------- | -------------------
[jenkins-x/jenkins-x-builders](https://github.com/jenkins-x/jenkins-x-builders.git) | [github.com/jenkins-x-charts/environment-controller](https://github.com/jenkins-x-charts/environment-controller) | [2.0.1117-453](https://github.com/jenkins-x/jenkins-x-builders/releases/tag/v2.0.1117-453) | **0.1.758**: [github.com/jenkins-x-charts/environment-controller](https://github.com/jenkins-x-charts/environment-controller)
[jenkins-x/jx](https://github.com/jenkins-x/jx) | [github.com/jenkins-x-charts/environment-controller](https://github.com/jenkins-x-charts/environment-controller);[github.com/jenkins-x-charts/prow](https://github.com/jenkins-x-charts/prow);[github.com/jenkins-x/jenkins-x-builders-ml](https://github.com/jenkins-x/jenkins-x-builders-ml.git);[github.com/jenkins-x/jenkins-x-builders](https://github.com/jenkins-x/jenkins-x-builders.git) | [2.0.1117](https://github.com/jenkins-x/jx/releases/tag/v2.0.1117) | **2.0.1116**: [github.com/jenkins-x-charts/prow](https://github.com/jenkins-x-charts/prow)<br>**2.0.806**: [github.com/jenkins-x-charts/environment-controller](https://github.com/jenkins-x-charts/environment-controller)
...
[jenkins-x-charts/environment-controller](https://github.com/jenkins-x-charts/environment-controller) |  | [0.0.623](https://github.com/jenkins-x-charts/environment-controller/releases/tag/v0.0.623) | 
...
[jenkins-x/jenkins-x-platform](https://github.com/jenkins-x/jenkins-x-platform) |  | [2.0.1847](https://github.com/jenkins-x/jenkins-x-platform/releases/tag/v2.0.1847) | 
[jenkins-x-charts/jx-build-templates](https://github.com/jenkins-x-charts/jx-build-templates) |  | [0.0.1307]() | 
...
[jenkins-x-charts/prow](https://github.com/jenkins-x-charts/prow) |  | [0.0.1586](https://github.com/jenkins-x-charts/prow/releases/tag/v0.0.1586) | 
...
[prometheus/alertmanager](https://github.com/prometheus/alertmanager) |  | [10.0.1]() | 
...
[jenkins-x/jenkins-x-builders-ml](https://github.com/jenkins-x/jenkins-x-builders-ml.git) |  | [0.1.1043](https://github.com/jenkins-x/jenkins-x-builders-ml/releases/tag/v0.1.1043) | 
...
[helm/nginx-ingress](https://github.com/helm/charts/tree/master/stable/nginx-ingress):nginx-ingress |  | [1.28.2]() | 
